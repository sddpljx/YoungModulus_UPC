...
namespace ModernUINavigationAppTest1.Pages.Settings
{
    /// <summary>
        ...
        : NotifyPropertyChanged
    {
        ...
        public AppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "暗", Source = AppearanceManager.DarkThemeSource });
            this.themes.Add(new Link { DisplayName = "亮", Source = AppearanceManager.LightThemeSource });
